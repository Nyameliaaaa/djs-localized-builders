...
import { type GetLocalizedStringOptions, setConfig, SlashCommandBuilder } from '../dist';
        ...
        describe('choices', () => {
            it('should set name, description and localizations', () => {
                const command = new SlashCommandBuilder('x')
                    .addStringOption('y', option => option.setChoices('z'))
                    .toJSON();
    ...
    describe('subcommands', () => {
        ...
        describe('options w/ choices', () => {
            ...
            describe('choices', () => {
                it('should set name, description and localizations', () => {
                    const command = new SlashCommandBuilder('x')
                        .addSubcommand('y', subcommand =>
                            subcommand.addStringOption('a', option => option.setChoices('b'))
                        )
                        .toJSON();
            ...
            describe('choices', () => {
                ...
                it('should handle mixed choices', () => {
                    const command = new SlashCommandBuilder('x')
                        .addSubcommandGroup('y', subcommandGroup =>
                            subcommandGroup.addSubcommand('z', subcommand =>
                                subcommand.addStringOption('a', option =>
                                    option.addChoices(['b', { key: 'c', value: 'd' }])
                                )
                            )
                        )
                        .toJSON();
